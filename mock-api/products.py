...
mocked_products = [
    {
        ...
        "reviews": [
            {"rating": 5, "comment": "Delicious and creamy!", "date": "2024-11-01",
             "reviewerName": "John Doe", "reviewerEmail": "john.doe@example.com"},
            {"rating": 4, "comment": "Good quality, would recommend.", "date": "2024-12-09",
             "reviewerName": "Jane Smith", "reviewerEmail": "jane.smith@example.com"}
        ],
    ...
    },
    {
        ...
        "availabilityStatus": "In Stock",
        "reviews": [
            {"rating": 5, "comment": "Great taste without the fat!", "date": "2024-10-05",
             "reviewerName": "Alice Johnson", "reviewerEmail": "alice.johnson@example.com"},
            {"rating": 4, "comment": "Good product, but the price could be better.",
             "date": "2024-10-28", "reviewerName": "Bob Lee", "reviewerEmail": "bob.lee@example.com"}
        ],
        "returnPolicy": "1 days return policy",
        "minimumOrderQuantity": 1,
        "meta": {
    ...
    },
    {
        ...
        "availabilityStatus": "In Stock",
        "reviews": [
            {"rating": 5, "comment": "Delicious and creamy!", "date": "2024-11-20",
             "reviewerName": "Chris Adams", "reviewerEmail": "chris.adams@example.com"},
            {"rating": 4, "comment": "Good for dairy alternatives, but expensive.",
             "date": "2024-12-02", "reviewerName": "Dana Lee", "reviewerEmail": "dana.lee@example.com"}
        ],
    ...
    },
    {
        ...
        "availabilityStatus": "In Stock",
        "reviews": [
            {"rating": 5, "comment": "Perfect for my cooking!", "date": "2024-10-05",
             "reviewerName": "Emma Green", "reviewerEmail": "emma.green@example.com"},
            {"rating": 4, "comment": "Good quality, could be cheaper.", "date": "2024-11-22",
             "reviewerName": "Frank Wright", "reviewerEmail": "frank.wright@example.com"}
        ],
    ...
    },
    {
        ...
        "availabilityStatus": "In Stock",
        "reviews": [
            {"rating": 5, "comment": "Great butter for cooking and baking!", "date": "2024-10-30",
             "reviewerName": "Helen Parker", "reviewerEmail": "helen.parker@example.com"},
            {"rating": 4, "comment": "A little too soft, but good flavor.", "date": "2024-12-12",
             "reviewerName": "George Davis", "reviewerEmail": "george.davis@example.com"}
        ],
    ...
    },
    {
        ...
        "availabilityStatus": "In Stock",
        "reviews": [
            {"rating": 5, "comment": "Tastes amazing, very fresh!", "date": "2024-12-01",
             "reviewerName": "Sophia Wilson", "reviewerEmail": "sophia.wilson@example.com"},
            {"rating": 4, "comment": "Good quality, but a bit expensive.", "date": "2024-12-31",
             "reviewerName": "Luke Harris", "reviewerEmail": "luke.harris@example.com"}
        ],
    ...
    },
    {
        ...
        "availabilityStatus": "In Stock",
        "reviews": [
            {"rating": 5, "comment": "Best eggs I've ever had!", "date": "2024-01-02",
             "reviewerName": "Olivia Brown", "reviewerEmail": "olivia.brown@example.com"},
            {"rating": 4, "comment": "Good quality but expensive.", "date": "2024-01-04",
             "reviewerName": "James Green", "reviewerEmail": "james.green@example.com"}
        ],
        "returnPolicy": "No return policy",
    ...
    },
    {
        ...
        "availabilityStatus": "In Stock",
        "reviews": [
            {"rating": 5, "comment": "Great taste, very fresh.", "date": "2024-11-03",
             "reviewerName": "Liam Scott", "reviewerEmail": "liam.scott@example.com"},
            {"rating": 4, "comment": "Good quality, will buy again.", "date": "2024-11-05",
             "reviewerName": "Ella Mitchell", "reviewerEmail": "ella.mitchell@example.com"}
        ],
        "returnPolicy": "No return policy",
        "minimumOrderQuantity": 6,
        "meta": {
    ...
    },
    {
        ...
        "availabilityStatus": "In Stock",
        "reviews": [
            {"rating": 5, "comment": "Nice quality eggs, good taste.", "date": "2024-12-04",
             "reviewerName": "Jack Taylor", "reviewerEmail": "jack.taylor@example.com"},
            {"rating": 4, "comment": "Fresh, but packaging could be better.", "date": "2025-01-02",
             "reviewerName": "Mia Roberts", "reviewerEmail": "mia.roberts@example.com"}
        ],
        "returnPolicy": "No return policy",
        "minimumOrderQuantity": 6,
        "meta": {
...
def get_products():
    ...
    total_products = len(mocked_products)
...
def search_products():
    ...
    logger.info(f"Products matching query '{query}': {len(filtered_products)}")
...
def get_products_by_category(category):
    ...
    logger.info(
        f"Products found in category '{category}': {len(filtered_products)}")
...
def get_brands():
    ...
    logger.info("Fetching all unique brands.")

    brands = list(set(product.get("brand", "Unknown")
                  for product in mocked_products))
...
if __name__ == '__main__':
    ...
    logger.info("Starting Flask server on localhost:5001")
